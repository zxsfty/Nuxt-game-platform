  ...
  <div class="space-y-8 py-6 px-4">
    <section class="hero-section bg-primary-light rounded-lg p-8 border border-primary-accent/30 transform transition-all duration-500 hover:shadow-theme relative overflow-hidden backdrop-blur-sm">
      ...
      <div class="max-w-3xl mx-auto text-center relative z-10">
        <h1 class="text-5xl font-bold mb-6 text-primary-accent animate-fadeIn font-serif">
    ...
    <section class="games-section">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div 
          ...
          :key="index" 
          class="bg-primary-light rounded-lg overflow-hidden border border-primary-accent/20 transition-all duration-300 transform hover:scale-105 hover:shadow-theme hover:border-primary-accent/50"
        ...
        >
          <div class="h-48 bg-secondary-dark flex items-center justify-center overflow-hidden group relative">
            ...
            <div class="text-6xl transition-all duration-500 transform group-hover:scale-125 group-hover:rotate-12 relative z-10">{{ game.emoji }}</div>
          ...
          <div class="p-4 relative">
            <h3 class="font-bold text-lg mb-2 transition-colors duration-300 hover:text-primary-accent">{{ game.name }}</h3>
            <div class="flex justify-between items-center">
              <span class="text-primary-accent transition-all duration-300 hover:scale-110 inline-block">{{ game.price }}</span>
              <button class="text-sm bg-primary-accent/80 hover:bg-primary-accent text-primary-light px-3 py-1 rounded-full transition-all duration-300 transform hover:scale-105 relative overflow-hidden">
                <span class="relative z-10">查看详情</span>
                <span class="absolute inset-0 bg-primary-accent opacity-0 hover:opacity-100 transition-opacity duration-300"></span>
              </button>
            </div>
          </div>
        </div>
